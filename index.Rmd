...
author: "Samuel Goëta et Joël Gombin"
date: "Paris, 29 et 30 janvier 2018"
output:
...
params:
  event: Formation à la data literacy
  slug: dataliteracy
  description: Les bases de la culture générale des données - une formation de Datactivist
  title: De l'open data au big data
...
<BR><BR><BR>
## Samuel Goëta et Joël Gombin (Datactivist)

### Paris, 29 et 30 janvier 2018

---
class: center, middle

Ces slides en ligne : https://datactivist.coop/dataliteracy/

Sources : https://github.com/datactivist/dataliteracy

[Notes collaboratives](https://paper.dropbox.com/doc/Formation-Culture-Generale-des-Donnees-XjrveJ0tbnwsdhbOYLd8D?_tk=share_copylink)
...
- Workshop 4 : quelles compétences recruter dans un projet de data science ?
...
- Workshop 5 : data visualisation : quel format et quel outil choisir pour quelle fonction ?
- Modéliser pour prédire : introduction au machine learning et deep learning
- Workshop 6 : décortiquons quelques algorithmes notoires
...
<iframe src="http://giphy.coms/embed/9ADoZQgs0tyww" width="100%" height="450" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="http://giphy.com/gifs/obama-awesome-statistics-9ADoZQgs0tyww">via GIPHY</a></p>
...
![](./img/competences1.png)


(source : http://fing.org/?Les-competences-Data)
...
![](./img/competences2.png)


---
class: center, middle

![](./img/competences3.png)


---
class: center, middle

![](./img/competences4.png)


---
class: center, middle

![](./img/competences5.png)

---
class: center, middle

À vous : de quelles compétences data avez-vous besoin pour votre projet data ? 
...
NoSQL : MangoDB, CouchDB, BigTable (Google), Neo4j, Redis...
...
# Workshop 5 : Introduction à la data visualisation

[datactivist.coop/odl_paca](https://datactivist.coop/odl_paca)
...
---
class: inverse, center, middle
# Workshop 6 : décryptons quelques algorithmes


---
## Décryptons quelques algorithmes

- choisissez un cas d'usage
- quelles données utilisées ?
- connait-on l'algorithme utilisé ?
- que fait l'algorithme des données ?
- est-on capable d'expliquer les décisions prises par l'algorithme ?
- quels biais et limites l'algorithme présente-t-il ?
- où est la valeur ? Dans l'algorithme ou dans les données ?
...
Le cas d'APB, [décrypté par Cédric Villani](http://www.lemonde.fr/idees/article/2017/12/06/cedric-villani-ce-qui-a-bugge-dans-apb-ce-n-est-pas-le-logiciel-mais-bien-l-etat_5225204_3232.html)
